    ...
    <div class="relative bg-gray-50 py-16 sm:py-24 lg:py-32">
        <div class="relative">
          ...
          >
              ...
              <div class="flex flex-1 flex-col justify-between bg-white p-6">
                <div class="flex-1">
                  <p class="text-sm font-medium text-cyan-600">
                    <a href="#" class="hover:underline"> Udacity </a>
                  </p>
                ...
                <div class="mt-6 flex items-center">
                  <div class="ml-3">
                    <div class="flex space-x-1 text-sm text-gray-500">
                      <time datetime="2020-03-16"> Jan 2020 - Jun 2021 </time>
                      <span aria-hidden="true"> &middot; </span>
                      <span> 1 yr 6 mos </span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="flex flex-col overflow-hidden shadow-lg">
              <div class="flex-shrink-0">
                <img class="h-48 w-full object-cover" src="../../public/MADI.jpg" alt="MADI" />
              </div>
              <div class="flex flex-1 flex-col justify-between bg-white p-6">
                <div class="flex-1">
                  <p class="text-sm font-medium text-cyan-600">
                    <a href="#" class="hover:underline">
                      ...
                      (State TechnicalUniversity) (MADI)</a
                    >
                  </p>
                  <a href="#" class="mt-2 block">
                ...
                <div class="mt-6 flex items-center">
                  <div class="ml-3">
                    <div class="flex space-x-1 text-sm text-gray-500">
                      <time datetime="2020-03-16"> 2001 - 2006</time>
                      <span aria-hidden="true"> &middot; </span>
                      <span> 5 yr </span>
                    </div>
                  </div>
